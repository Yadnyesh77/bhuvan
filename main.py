...
try:
    ...
    df = pd.DataFrame(columns=['Action', 'Target', 'Timestamp','x_Coordinates','y_Coordinates', 'browser', 'browserVersion', 'microtime', 'scrnwidth','scrnheigth' 'ipAddress', 'url', 'starttime', 'endtime','ctrl','alt','shift','meta'])
...
def update_excel_sheet():
    ...
    try:
        ...
        new_df = pd.DataFrame(columns=['Action', 'Target', 'Timestamp', 'x_Coordinates','y_Coordinates', 'browser', 'browserVersion', 'microtime', 'scrnwidth','scrnheight', 'ipAddress', 'url', 'starttime', 'endtime','ctrl','alt','shift','meta'])
...
def log_endpoint():
    ...
    df = pd.DataFrame(columns=['Action', 'Target', 'Timestamp', 'x_Coordinates','y_Coordinates', 'browser', 'browserVersion', 'microtime', 'scrnwidth','scrnheight', 'ipAddress', 'url', 'starttime', 'endtime','ctrl','alt','shift','meta'])
